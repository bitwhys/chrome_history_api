...
var $adfb4e117f17d1df$export$2e2bcd8739ae039 = new $9749222ac2c29308$export$2e2bcd8739ae039({
  defaults: {
    colorRed: 244,
    colorGreen: 67,
    colorBlue: 54,
...
const $e31adcf64b4b04d3$var$rangeInputs = [ ...document.querySelectorAll('input[type="range"][name^="color"]') ], $e31adcf64b4b04d3$var$numberInputs = [ ...document.querySelectorAll('input[type="number"][name^="color"]') ], $e31adcf64b4b04d3$var$output = document.querySelector(".color-output");

function $e31adcf64b4b04d3$var$updateOutputColor() {
  $e31adcf64b4b04d3$var$output.style.backgroundColor = `rgb(${$e31adcf64b4b04d3$var$rangeInputs[0].value}, ${$e31adcf64b4b04d3$var$rangeInputs[1].value}, ${$e31adcf64b4b04d3$var$rangeInputs[2].value})`;
}

function $e31adcf64b4b04d3$var$updateInputField(event) {
  $e31adcf64b4b04d3$var$numberInputs[$e31adcf64b4b04d3$var$rangeInputs.indexOf(event.currentTarget)].value = event.currentTarget.value;
}

for (const input of $e31adcf64b4b04d3$var$rangeInputs) input.addEventListener("input", $e31adcf64b4b04d3$var$updateOutputColor), 
input.addEventListener("input", $e31adcf64b4b04d3$var$updateInputField);

!async function() {
  await $adfb4e117f17d1df$export$2e2bcd8739ae039.syncForm("#options-form"), $e31adcf64b4b04d3$var$updateOutputColor();
}();