...
var $b02e5677d6d62361$export$2e2bcd8739ae039 = new $9749222ac2c29308$export$2e2bcd8739ae039({
  defaults: {
    colorRed: 244,
    colorGreen: 67,
    colorBlue: 54,
...
const $953ea60ed99ac78e$var$rangeInputs = [ ...document.querySelectorAll('input[type="range"][name^="color"]') ], $953ea60ed99ac78e$var$numberInputs = [ ...document.querySelectorAll('input[type="number"][name^="color"]') ], $953ea60ed99ac78e$var$output = document.querySelector(".color-output");

function $953ea60ed99ac78e$var$updateOutputColor() {
  $953ea60ed99ac78e$var$output.style.backgroundColor = `rgb(${$953ea60ed99ac78e$var$rangeInputs[0].value}, ${$953ea60ed99ac78e$var$rangeInputs[1].value}, ${$953ea60ed99ac78e$var$rangeInputs[2].value})`;
}

function $953ea60ed99ac78e$var$updateInputField(event) {
  $953ea60ed99ac78e$var$numberInputs[$953ea60ed99ac78e$var$rangeInputs.indexOf(event.currentTarget)].value = event.currentTarget.value;
}

for (const input of $953ea60ed99ac78e$var$rangeInputs) input.addEventListener("input", $953ea60ed99ac78e$var$updateOutputColor), 
input.addEventListener("input", $953ea60ed99ac78e$var$updateInputField);

!async function() {
  await $b02e5677d6d62361$export$2e2bcd8739ae039.syncForm("#options-form"), $953ea60ed99ac78e$var$updateOutputColor();
}();