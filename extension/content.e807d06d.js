(() => {
  ...
  var $b909eab51de6b3fb$export$2e2bcd8739ae039 = new $fdd0aaa2d9b88141$export$2e2bcd8739ae039({
    defaults: {
      colorRed: 244,
      colorGreen: 67,
      colorBlue: 54,
  ...
  async function() {
    const options = await $b909eab51de6b3fb$export$2e2bcd8739ae039.getAll(), color = "rgb(" + options.colorRed + ", " + options.colorGreen + "," + options.colorBlue + ")", text = options.text, notice = document.createElement("div");
